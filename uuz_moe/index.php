    ...
    <section id="main">
        ...
        <footer>
            <ul class="icons">
                ...
                <li><a href="https://github.com/hanzexu990323/" class="fa-github">GitHub</a></li>
		<li><a href="https://plus.google.com/+韩柘旭
/" class="fa-google-plus">Google+</a></li>
            </ul>
            <ul class="actions">
                <li><a href="https://blog.uuz.moe" class="button">Blog</a></li>
            </ul>
        </footer>
    </section>
    ...
    <footer id="footer">
            ...
            <ul class="copyright">
            <li>Design: <a href="https://blog.uuz.moe">雨宮千夏
